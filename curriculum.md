...
| 번호 | 주제 | 파일명 | 진행 |
|------|------|--------|------|
| 01-01 | OSI 7계층 / TCP-IP 4계층 | `01-01-osi-tcpip.md` | [ ] |
| 01-02 | TCP vs UDP | `01-02-tcp-udp.md` | [ ] |
| 01-03 | DNS 동작 원리 | `01-03-dns.md` | [ ] |
| 01-04 | HTTP vs HTTPS | `01-04-http-https.md` | [ ] |
| 01-05 | 쿠키 / 세션 / JWT | `01-05-cookie-session-jwt.md` | [ ] |
| 01-06 | REST API 설계 원칙 | `01-06-rest-api.md` | [ ] |
| 01-07 | TCP 3-way / 4-way Handshake | `01-07-tcp-handshake.md` | [ ] |
| 01-08 | HTTP/1.1 vs HTTP/2 vs HTTP/3 | `01-08-http-versions.md` | [ ] |
| 01-09 | 웹소켓 vs HTTP | `01-09-websocket.md` | [ ] |
| 01-10 | CORS | `01-10-cors.md` | [ ] |
| 01-11 | 로드 밸런싱 | `01-11-load-balancing.md` | [ ] |
| 01-12 | CDN | `01-12-cdn.md` | [ ] |
| 01-13 | 방화벽 / 프록시 / NAT | `01-13-firewall-proxy-nat.md` | [ ] |
